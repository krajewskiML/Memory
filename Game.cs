...
namespace Memory
{
    public partial class Game : Form
    {
        ...
        private bool arePreviousVisible;
        ...
        {
            milis += 100;
            this.Text = "Memory, time: " + (milis/1000).ToString() + ":" + (milis%1000).ToString();
        ...
        private void PictureBox_Click(object sender, EventArgs e)
        {
            ...
            if (!(sender is PictureBox) || ((sender as PictureBox).Image!=Unnknown && (sender as PictureBox)!= firstClick && (sender as PictureBox) != secondClick))
            {
                return;
            }
            else
            {
                if (arePreviousVisible)
                {
                    firstClick.Image = Unnknown;
                    secondClick.Image = Unnknown;
                    firstClick = null;
